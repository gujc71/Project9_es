...
INSERT INTO `tbl_board` (`BGNO`, `BRDNO`, `BRDTITLE`, `USERNO`, `BRDMEMO`, `BRDDATE`, `LASTDATE`, `LASTUSERNO`, `BRDDELETEFLAG`) VALUES
	(3, 2, '모바일 웹 사이트 제작 및 프로그래밍', 11, '모바일 웹 사이트 제작 및 프로그래밍', SYSDATE(), SYSDATE(), 11, 'N'),
	(3, 3, '세상의 속도를 따라잡고 싶다면 DO IT(HTML5 CSS3)', 15, '세상의 속도를 따라잡고 싶다면 DO IT(HTML5 CSS3)', SYSDATE(), SYSDATE(), 15, 'N'),
	(3, 4, '마음을 움직이는 콘텐츠디자인', 44, '마음을 움직이는 콘텐츠디자인', SYSDATE(), SYSDATE(), 44, 'N'),
	(3, 5, '필요할 때마다 골라쓰는 프레젠테이션 디자인 100', 13, '필요할 때마다 골라쓰는 프레젠테이션 디자인 100', SYSDATE(), SYSDATE(), 13, 'N'),
	(3, 6, '안드로이드 앱 개발 완벽 가이드', 15, '안드로이드 앱 개발 완벽 가이드', SYSDATE(), SYSDATE(), 15, 'N'),
	(3, 7, '가치관 경영', 36, '가치관 경영', SYSDATE(), SYSDATE(), 36, 'N'),
	(3, 8, 'Ext JS 웹 애플리케이션 개발', 55, 'Ext JS 웹 애플리케이션 개발', SYSDATE(), SYSDATE(), 55, 'N'),
	(3, 9, '힐링 코드', 6, '힐링 코드', SYSDATE(), SYSDATE(), 6, 'N'),
	(3, 10, '고급 웹 표준 사이트제작을 위한 CSS 마스터 전략', 29, '고급 웹 표준 사이트제작을 위한 CSS 마스터 전략', SYSDATE(), SYSDATE(), 29, 'N'),
	(3, 11, 'DB나라-나는 DB다', 44, 'DB나라-나는 DB다', SYSDATE(), SYSDATE(), 44, 'N'),
	(3, 12, 'HTML5 Canvas', 53, 'HTML5 Canvas', SYSDATE(), SYSDATE(), 53, 'N'),
	(3, 13, 'Javascript Graphics', 53, 'Javascript Graphics', SYSDATE(), SYSDATE(), 53, 'N'),
	(3, 14, '루씬 인 액션 - 오픈소스 자바 검색엔진', 24, '루씬 인 액션 - 오픈소스 자바 검색엔진', SYSDATE(), SYSDATE(), 24, 'N'),
	(3, 15, 'Jquery in action', 44, 'Jquery in action', SYSDATE(), SYSDATE(), 44, 'N'),
	(3, 16, 'Jquery 1.7 작고 강력한 자바스크립트', 66, 'Jquery 1.7 작고 강력한 자바스크립트', SYSDATE(), SYSDATE(), 66, 'N'),
	(3, 17, '프로 스프링3', 37, '프로 스프링3', SYSDATE(), SYSDATE(), 37, 'N'),
	(3, 18, '스트럿츠 2 프로그래밍', 68, '스트럿츠 2 프로그래밍', SYSDATE(), SYSDATE(), 68, 'N'),
	(3, 19, '스트럿츠2 실무 프로그래밍', 69, '스트럿츠2 실무 프로그래밍', SYSDATE(), SYSDATE(), 69, 'N'),
	(3, 20, 'CSS 비밀 매뉴얼(감추고 싶은 나만의 비밀 노트) ', 62, 'CSS 비밀 매뉴얼(감추고 싶은 나만의 비밀 노트) ', SYSDATE(), SYSDATE(), 62, 'N'),
	(3, 21, 'Ext JS 4 First look 한국어판/화려한 웹 애플리케이션을 위한 Ext JS 입문', 20, 'Ext JS 4 First look 한국어판/화려한 웹 애플리케이션을 위한 Ext JS 입문', SYSDATE(), SYSDATE(), 20, 'N'),
	(3, 22, 'SQL 전문가 가이드', 77, 'SQL 전문가 가이드', SYSDATE(), SYSDATE(), 77, 'N'),
	(3, 23, '성장의 정석 CRS 기업의 지속 성장을 위한 핵심 경영 전략', 3, '성장의 정석 CRS 기업의 지속 성장을 위한 핵심 경영 전략', SYSDATE(), SYSDATE(), 3, 'N'),
	(3, 24, '실전 프로젝트 관리를 위한 MS Project 2010 ', 27, '실전 프로젝트 관리를 위한 MS Project 2010 ', SYSDATE(), SYSDATE(), 27, 'N'),
	(3, 25, '워드프레스 제대로 파기', 45, '워드프레스 제대로 파기', SYSDATE(), SYSDATE(), 45, 'N'),
	(3, 26, '클라우드 컴퓨팅 구현 기술: 구글, 페이스북, 야후, 아마존이 채택한 핵심 기술 파헤치기', 64, '클라우드 컴퓨팅 구현 기술: 구글, 페이스북, 야후, 아마존이 채택한 핵심 기술 파헤치기', SYSDATE(), SYSDATE(), 64, 'N'),
	(3, 27, 'Real MySQL: 개발자와 DBA를 위한', 25, 'Real MySQL: 개발자와 DBA를 위한', SYSDATE(), SYSDATE(), 25, 'N'),
	(3, 28, '스프링4 프로그래밍(Getting started with Spring Framework)', 15, '스프링4 프로그래밍(Getting started with Spring Framework)', SYSDATE(), SYSDATE(), 15, 'N'),
	(3, 29, '웹 퍼포먼스 모니터링과 디버깅', 80, '웹 퍼포먼스 모니터링과 디버깅', SYSDATE(), SYSDATE(), 80, 'N'),
	(3, 30, '아파치 Solr 4 구축과 관리(루씬 검색 플랫폼)', 31, '아파치 Solr 4 구축과 관리(루씬 검색 플랫폼)', SYSDATE(), SYSDATE(), 31, 'N'),
	(3, 31, '2015 알기쉬운 정보보안 기사 필기', 78, '2015 알기쉬운 정보보안 기사 필기', SYSDATE(), SYSDATE(), 78, 'N'),
	(3, 32, '2016 알기쉬운 정보보안 기사 실기', 54, '2016 알기쉬운 정보보안 기사 실기', SYSDATE(), SYSDATE(), 54, 'N'),
	(3, 33, 'Apache Jmeter', 37, 'Apache Jmeter', SYSDATE(), SYSDATE(), 37, 'N'),
	(3, 34, '코드 품질 시각화의 정석', 24, '코드 품질 시각화의 정석', SYSDATE(), SYSDATE(), 24, 'N'),
	(3, 35, 'RabbitMQ 따라잡기 : AMQP 기반의 오픈소스 메시지 브로커 ', 10, 'RabbitMQ 따라잡기 : AMQP 기반의 오픈소스 메시지 브로커 ', SYSDATE(), SYSDATE(), 10, 'N'),
	(3, 36, 'Hyper-V를 다루는 기술', 59, 'Hyper-V를 다루는 기술', SYSDATE(), SYSDATE(), 59, 'N'),
	(3, 37, '윈도우 서버 2012 R2', 24, '윈도우 서버 2012 R2', SYSDATE(), SYSDATE(), 24, 'N'),
	(3, 38, '거침없이 배우는 Jboss', 24, '거침없이 배우는 Jboss', SYSDATE(), SYSDATE(), 24, 'N');
